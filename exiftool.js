    ...
    (function() {
        ...
        function readTagValue(oFile, iEntryOffset, iTIFFStart, iDirStart,
            ...
            case 5: // rational = two long values, first is numerator, second is
                // denominator
                if (iNumValues == 1) {
                    var numerator = oFile.getLongAt(iValueOffset, bBigEnd);
                    var denominator = oFile.getLongAt(iValueOffset + 4, bBigEnd);
        ...
        if (typeof (exports) !== 'undefined') {
            ...
            exports.getData = EXIF.getData;
            exports.getAllTags = EXIF.getAllTags;
        }
